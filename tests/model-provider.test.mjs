...
function clearLayraProviderEnv() {
  for (const key of [
    'LAYRA_MODEL_NAME', 'LAYRA_MODEL', 'LAYRA_MODEL_PROVIDER', 'LAYRA_MODEL_API_KEY_ENV',
    'LAYRA_MODEL_API_ENDPOINT', 'LAYRA_MODEL_TEMPERATURE', 'LAYRA_MODEL_MAX_TOKENS',
    'CUSTOM_MODEL_KEY', 'NVIDIA_API_KEY'
